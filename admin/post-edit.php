	...
	try{
		...
		if(empty($_FILES["post_image"]["name"])){
			...
			if(($file_ext!='.png') && ($file_ext!='.jpg') && ($file_ext!='.jpeg') && ($file_ext!='.gif')){
				throw new Exception("Only jpj, jpeg, png and gif format images are allowed upload.");
			}
	...
	<table class="tbl1">
		...
		<tr>
			...
			<script type="text/javascript">
				...
				{
					document.write(
						'<strong><span style="color:#ff0000">Error</span>: CKEditor not found</strong>.' + 'This sample assumes that CKEditor (not included with CKEditor) is installed in' + 'the "/ckeditor/" path. If you have it installed in a diferent place, just edit' + 'this file, changing the wrong paths in the &lt;head&gt; (line 5) and the "BasePath"' + 'value (line 32).' ) ;
				}
				else
				{
					var editor = CKEDITOR.replace( 'post_description' );
					//editor.setData( '<p> Just click the <b>Image</b> or <b>Link</b> button, and then <b>&quot;BrowseServer&qout;</b>.</p>');
				}
		...
		<tr>
		<td><img src="../uploads/<?php echo $post_image;?>" alt="" width="200"></td>
		</tr>
		<tr>
